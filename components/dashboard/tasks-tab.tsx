...
export function TasksTab() {
  ...
  const getPriorityColor = (priority: string) => {
    switch (priority) {
      case "high":
        return "bg-red-100 text-red-800 hover:bg-red/90"
      case "medium":
        return "bg-yellow-100 text-yellow-800 hover:bg-yellow/90"
      case "low":
        return "bg-green-100 text-green-800 hover:bg-green/90"
      default:
